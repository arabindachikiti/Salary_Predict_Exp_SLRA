...
model = pickle.load(open(r'C:\Users\Arabinda\VS CODE\Machine Learning\Salary_data_SampleLinearRegression\Linear_regression_model_pkl', 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by Arabinda Panigrahi")